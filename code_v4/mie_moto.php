...
if ($azione === 'elimina' && $id) {
    ...
    if ($stmt->fetch()) {
        try {
            ...
            header('Location: mie_moto.php?ok=1');
            exit;
    ...
    <div class="container">
        ...
        <?php else: ?>
            ...
            <form method="POST">
                ...
                <div>
                    <label>Targa *</label>
                    <input type="text" name="targa" value="<?= htmlspecialchars($moto['targa'] ?? '') ?>" required
                        maxlength="10">
                </div>
                <div>
                    <label>Marca *</label>
                ...
                <div>
                    <label>Anno *</label>
                    <input type="number" name="anno" value="<?= $moto['anno'] ?? date('Y') ?>" min="1900"
                        max="<?= date('Y') ?>" required>
                </div>
