    ...
    <?php else: ?>
        ...
        <form method="POST">
            ...
            <div>
                ...
                <input type="text" name="ragione_sociale" value="<?= htmlspecialchars($forn['ragione_sociale'] ?? '') ?>" required>
            </div>
            <div>
                <label>Partita IVA *</label>
                <input type="text" name="partita_iva" value="<?= htmlspecialchars($forn['partita_iva'] ?? '') ?>" required>
            </div>
            <div>
                <label>Email</label>
